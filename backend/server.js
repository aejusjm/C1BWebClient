...
const cohortManagementRoutes = require('./routes/cohortManagement');
const allProductManagementRoutes = require('./routes/allProductManagement');
...
const subscriptionSettlementRoutes = require('./routes/subscriptionSettlement');
...
app.use('/api/cohorts', cohortManagementRoutes);
app.use('/api/all-products', allProductManagementRoutes);
...
app.use('/api/subscription-settlement', subscriptionSettlementRoutes);
